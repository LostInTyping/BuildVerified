...
const ohioOffenseCodePortal: TerminalScenario = {
  ...
  logEntries: [
    ...
    { message: "  offense code management", tone: "muted", delayMs: 100 },
    { message: "    \u2713 GET /offenses returns paginated offense list (72 ms)", tone: "pass", delayMs: 130 },
    { message: "    \u2713 GET /offenses/:code returns correct statute details (48 ms)", tone: "pass", delayMs: 110 },
    { message: "    \u2713 POST /offenses validates required fields before save (34 ms)", tone: "pass", delayMs: 100 },
    { message: "    \u2713 PUT /offenses/:code updates offense classification (61 ms)", tone: "pass", delayMs: 120 },
    { message: " PASS  tests/integration/osdp-sync.spec.ts", tone: "pass", delayMs: 180 },
    { message: "  OSDP integration", tone: "muted", delayMs: 100 },
    { message: "    \u2713 synced offense codes match OCP source data (186 ms)", tone: "pass", delayMs: 160 },
    { message: "    \u2713 updated offense propagates to OSDP within sync window (203 ms)", tone: "pass", delayMs: 170 },
    { message: "    \u2713 deleted offense code is flagged inactive in OSDP (94 ms)", tone: "pass", delayMs: 130 },
    { message: "", tone: "muted", delayMs: 80 },
    { message: "Test Suites:  2 passed, 2 total", tone: "pass", delayMs: 120 },
    { message: "Tests:        7 passed, 7 total", tone: "pass", delayMs: 80 },
    { message: "Snapshots:    0 total", tone: "muted", delayMs: 60 },
    { message: "Time:         1.924 s", tone: "muted", delayMs: 60 },
    { message: "Ran all test suites.", tone: "muted", delayMs: 80 },
  ],
};
...
const itExpo: TerminalScenario = {
  ...
  logEntries: [
    ...
    { message: "", tone: "muted", delayMs: 100 },
    { message: "  Homepage", tone: "muted", delayMs: 120 },
    { message: "    \u2713 Landing page loads with correct event details", tone: "pass", delayMs: 140 },
    { message: "    \u2713 Navigation links resolve to correct sections", tone: "pass", delayMs: 120 },
    { message: "    \u2713 Event schedule displays current year data", tone: "pass", delayMs: 130 },
    { message: "", tone: "muted", delayMs: 80 },
    { message: "  Registration", tone: "muted", delayMs: 120 },
    { message: "    \u2713 Registration form validates required fields", tone: "pass", delayMs: 140 },
    { message: "    \u2713 Confirmation email sent on successful submit", tone: "pass", delayMs: 130 },
    { message: "", tone: "muted", delayMs: 80 },
    { message: "  Project Submissions", tone: "muted", delayMs: 120 },
    { message: "    \u2713 Student project submission form accepts uploads", tone: "pass", delayMs: 140 },
    { message: "    \u2713 Submitted projects appear in admin review queue", tone: "pass", delayMs: 130 },
    { message: "", tone: "muted", delayMs: 60 },
    { message: "7 checks passed, 0 failed", tone: "pass", delayMs: 120 },
    { message: "Manual test pass complete.", tone: "pass", delayMs: 100 },
  ],
};
